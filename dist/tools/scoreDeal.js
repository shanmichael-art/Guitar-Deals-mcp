...
export async function scoreDeal(args) {
    const { outboundShipping, strongOffer, walkAwayMax } = calculateStrongOffer(args.askPrice, args.shippingPrice);
    const notes = [];
    let verdict = "watch";
    const spreadToEstimatedValue = args.estimatedValue != null
